...
class CartRepository {
    ...
    async retrieve(userID) {
        try {
            ...
            var res = await req.query('select * from Koszyk WHERE UserID = @userID');
    ...
    async insert(productID, userID) {
        try {
            ...
            INSERT INTO Koszyk (UserID, ProductID, Ilosc) VALUES (@userID, @productID, 1) SELECT scope_identity() as id;
            ELSE BEGIN 
